<%-- 
    Document   : login.jsp
    Created on : 12-mar-2021, 12:48:53
    Author     : Cristhian
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item">
                            <a id="login" class="nav-link btn btn-primary btn-lg text-uppercase js-scroll-trigger" class="conn" href="login.jsp">Login <i class="fa fa-lock"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="registrarse.jsp">
                                Registrarse
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" style="margin-top: 10px;" value="remember-me">
                                        Recordar clave
                                    </label>
                                </div>
                            </div>
                            <a class="btn btn-primary btn-block" style="margin-top: 10px;" href="index.html">Ingresar</a>
                        </form>
                        <div class="text-center">
                            <a class="d-block medium" href="forgot-password.html">¿Olvidó su contraseña?</a>
                        </div>
                    </div>
                </div>
            </div>
